...
# Note: The password is expired
import requests
from datetime import datetime
import smtplib
import time

MY_LAT = 50.110924  # My latitude
MY_LONG = 8.682127  # My longitude
MY_EMAIL = "emuout@gmail.com"
PASSWORD = "lncgbzacwhakgxwr" # This is expired
...
while True:
    time.sleep(60) # every 60s I'll get an email
    if is_iss_overhead and is_night:
        with smtplib.SMTP("smtp.gmail.com") as connection:
            ...
            connection.sendmail(from_addr=MY_EMAIL,
                                ...
                                msg="Subject:Look Up To See The ISS\n\nThe ISS is above you on the sky."
                                )
